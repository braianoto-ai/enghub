    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <nav className="mb-6 flex items-center gap-2 text-sm text-zinc-400 dark:text-zinc-500">
          <Link href={`/${slug}`} className="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
            {tenant.name}
          </Link>
          <span>/</span>
          <Link href={`/${slug}/projetos`} className="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
            Projetos
          </Link>
          <span>/</span>
        ...
        <div className="mb-6">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            <span className="rounded-full bg-violet-50 px-3 py-1 text-sm font-medium text-violet-700 dark:bg-violet-900/20 dark:text-violet-400">
              {areaLabel}
            </span>
            {project.location && (
        ...
        {/* CTA */}
        <div className="mb-10 rounded-2xl border border-violet-200 bg-violet-50 p-6 text-center dark:border-violet-800/40 dark:bg-violet-900/10">
          <Shield size={24} className="mx-auto mb-3 text-violet-500" />
          ...
          <Link
            href={`/${slug}/contato`}
            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-violet-600 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-violet-500"
          >
              ...
              {otherProjects.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-3">
                      <p className="truncate text-sm font-medium text-zinc-900 group-hover:text-violet-600 dark:text-zinc-100 dark:group-hover:text-violet-400">
                        {p.title}
                      </p>
