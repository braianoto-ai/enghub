  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        {/* CTA inline */}
        <div className="mt-12 rounded-2xl border border-violet-200 bg-violet-50 p-6 dark:border-violet-800/50 dark:bg-violet-900/20">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <Link href="/cadastro">
                <button className="mt-3 flex items-center gap-1.5 rounded-lg bg-violet-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-violet-500">
                  Criar meu perfil
                  <ArrowRight size={14} />
                </button>
              </Link>
              ...
              {others.map((p) => (
                <Link key={p.slug} href={`/blog/${p.slug}`} className="group">
                  <div className="rounded-xl border border-zinc-200 bg-white p-5 transition-shadow hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900">
                    ...
                    <h3 className="mt-3 text-sm font-bold leading-snug text-zinc-900 group-hover:text-violet-600 dark:text-zinc-100 dark:group-hover:text-violet-400 transition-colors">
                      {p.title}
                    </h3>
