    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 px-4 py-28 text-center">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-1/3 top-0 h-96 w-96 -translate-x-1/2 rounded-full bg-violet-600/10 blur-3xl" />
          <div className="absolute right-1/4 bottom-0 h-64 w-64 rounded-full bg-violet-500/8 blur-3xl" />
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div className="mt-8 space-y-3">
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  <CheckCircle size={18} className="shrink-0 text-violet-600" />
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-950 to-violet-950/60 p-8">
      ...
      <div className="px-4 pb-20">
        <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-950 via-violet-950/40 to-zinc-950 p-12 text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link href="/cadastro">
              <button className="flex items-center gap-2 rounded-xl bg-violet-600 px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/25 transition hover:bg-violet-500">
                Criar perfil grátis
                <ArrowRight size={16} />
              </button>
            </Link>
