...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)]">
      {/* Left — branding */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-zinc-950 via-zinc-900 to-violet-950/60 px-12 py-16">
          ...
          <div className="mt-10 space-y-4">
            {[
              ...
              <div key={item.text} className="flex items-center gap-3 text-zinc-300">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-violet-900/40">
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center px-6 py-12 bg-white dark:bg-zinc-950">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-2.5 text-sm text-gray-900 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-zinc-300 bg-white px-4 py-2.5 pr-10 text-sm text-gray-900 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-white"
                />
                <button
                  type="button"
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            Não tem conta?{" "}
            <Link href="/cadastro" className="font-medium text-violet-600 hover:underline dark:text-violet-400">
              Cadastre-se grátis
            </Link>
          </p>
        </div>
