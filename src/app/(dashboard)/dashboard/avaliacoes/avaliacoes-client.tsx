                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {currentReply && !isReplying && (
                      <div className="mt-3 flex gap-2 rounded-xl border border-gray-100 bg-gray-50 p-3 dark:border-zinc-700 dark:bg-zinc-800">
                        ...
                        <button
                          ...
                          className="shrink-0 text-gray-400 hover:text-gray-600 dark:hover:text-zinc-300"
                    ...
                    {isReplying ? (
                      ...
                      <button
                        onClick={() => startReply(r)}
                        className="mt-3 flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 dark:text-zinc-400 dark:hover:text-zinc-200"
                      >
