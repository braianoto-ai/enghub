          ...
          <CardContent>
                ...
                {existingImages.map((img, i) => (
                  <div key={img.id} className="relative aspect-square">
                    ...
                    {i === 0 && existingImages.length + newImages.length > 0 && (
                      <span className="absolute left-1 top-1 rounded bg-gray-700 px-1 py-0.5 text-[10px] font-semibold text-white">Capa</span>
                    )}
            ...
            {totalImages < MAX_IMAGES && (
              <button
                ...
                className="flex h-24 w-full flex-col items-center justify-center gap-1 rounded-lg border-2 border-dashed border-gray-300 text-gray-400 transition-colors hover:border-gray-400 hover:text-gray-500"
              >
                <ImagePlus size={24} />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <select value={area} onChange={(e) => setArea(e.target.value)} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500" required>
            ...
            <div className="space-y-1">
              ...
              <textarea value={description} onChange={(e) => setDescription(e.target.value)} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500" rows={4} />
            </div>
            ...
            <div className="space-y-1">
              ...
              <select value={status} onChange={(e) => setStatus(e.target.value)} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-500">
