...
export const metadata: Metadata = {
  ...
  description:
    "Artigos sobre carreira, portfólio, precificação e marketing para engenheiros e arquitetos. Digest semanal gerado com curadoria de IA.",
};
      ...
      <div className="border-b border-zinc-100 bg-zinc-50 px-4 py-16 dark:border-zinc-800 dark:bg-zinc-900/40">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-2 max-w-xl text-zinc-500 dark:text-zinc-400">
            Dicas práticas de carreira, portfólio, precificação e marketing — mais digest semanal com as principais notícias do setor, gerado automaticamente toda semana.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
                ...
                <div className="flex min-h-48 items-center justify-center bg-gradient-to-br from-zinc-950 via-zinc-900/50 to-zinc-900 p-10 lg:min-h-64">
                  <div className="text-center">
                    <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-700/20 ring-1 ring-gray-500/30">
                      {featured.isAiGenerated
                        ? <Sparkles size={28} className="text-violet-400" />
                        : <BookOpen size={28} className="text-gray-400" />
                      }
                    </div>
                    <p className="mt-3 text-sm font-medium text-gray-300">
                      {featured.isAiGenerated ? "Digest semanal" : "Artigo em destaque"}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-medium text-zinc-900 dark:text-zinc-100">{featured.author.name}</p>
        ...
        {posts.length === 0 && (
          <div className="flex flex-col items-center gap-3 py-24 text-center">
            <BookOpen size={40} className="text-zinc-300 dark:text-zinc-600" />
            <p className="text-zinc-500 dark:text-zinc-400">Nenhum post encontrado.</p>
          </div>
        )}
        ...
        <div className="mt-16 rounded-2xl border border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700/50 dark:bg-gray-800/20">
          <p className="font-semibold text-zinc-900 dark:text-zinc-100">Quer seu portfólio profissional?</p>
