            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  <span className="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-800/20 dark:text-gray-400">
                ...
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-gray-700 hover:underline dark:text-gray-400"
                >
